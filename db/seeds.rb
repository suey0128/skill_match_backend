...
Event.create(recruiter_id: Recruiter.all[0].id, event_date: DateTime.strptime("07/30/2021 11:00", "%m/%d/%Y %H:%M"), name:"Lunch Event", location: "Seattle, WA", description: "Let's go grab lunch and talk about code!", image: "https://media-cdn.tripadvisor.com/media/photo-s/16/f3/0e/0c/the-pink-door-back-dining.jpg")
